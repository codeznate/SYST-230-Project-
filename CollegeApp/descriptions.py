...
major_descriptions = {
    "Business": {
        "descriptions": [
            ...
            "Explore entrepreneurship, operations, and leadership in a corporate context.",
            "Focus on business analytics, strategy, and decision-making for today's economy."
        ],
        "examples": [
    ...
    "Engineering": {
        "descriptions": [
            ...
            "Combine theory and practice across disciplines such as mechanical, civil, and electrical engineering.",
    ...
    "Biology": {
        "descriptions": [
            "Investigate living organisms at the molecular, cellular, and ecological levels.",
            "Learn about genetics, evolution, and ecosystems through hands‑on research.",
            "Apply biological knowledge to medicine, conservation, and biotechnology."
        ],
        "examples": [
    ...
    "Electrical Engineering": {
        "descriptions": [
            ...
            "Work on innovations in robotics, telecommunications, and energy."
        ],
        "examples": [
    ...
    "Civil Engineering": {
        "descriptions": [
            "Plan, design, and build infrastructure such as bridges, roads, and buildings.",
            "Integrate environmental science to create sustainable and resilient communities.",
            "Manage construction projects, water resources, and transportation systems."
        ],
        "examples": [
    ...
    "Biomedical Engineering": {
        "descriptions": [
            ...
            "Conduct research on biomaterials, biomechanics, and tissue engineering.",
            "Innovate in healthcare technology to improve diagnosis, treatment, and patient quality of life."
        ],
        "examples": [
    ...
    "Chemical Engineering": {
        "descriptions": [
            ...
            "Optimize production systems and scale up laboratory research to industrial applications.",
            "Develop sustainable manufacturing processes and drive innovation in energy and materials."
        ],
        "examples": [
    ...
    "Cybersecurity": {
        "descriptions": [
            ...
            "Study cryptography, network security, and risk management to defend digital assets.",
    ...
    "Computer Engineering": {
        "descriptions": [
            "Design computer hardware and embedded systems combining electrical engineering and CS.",
